...
mail("maratmavliev@mail.ru", $_POST['topic'], $_POST['email'].' '.$_POST['fname'].' '.$_POST['message']); 
    ...
    <head>
        <title>Usite - сайт, где пользователь сам выбирает дизайн. Технология Usite. Настройте дизайн сайта!</title>
        <meta charset="utf-8">
        ...
        <meta name="description" content="Сайт, где пользователь сам настраивает дизайн. Сайт с функцией настройки дизайна. Люди выбирают дизайн вашего сайта." />
        <link href="https://fonts.googleapis.com/css?family=Montserrat:100,300,400,900|Open+Sans:100,400,900|Oswald:100,400,900|Playfair+Display:100,400,900|Roboto&display:100,400,900=swap" rel="stylesheet">
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="400">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content bc">
                    ...
                    <div class="modal-body">
                        <div>
                            <div class="row form-group">
                                <div class="col">
                                    <div>
                                        <input type="color" value="#A8A8A8" class="in1" id="main-color-input" placeholder="2ekwerx">
                                    </div>
                                    <div>
                        ...
                        <div>
                            <div class="row form-group">
                                <div class="col text-center head-font">
                                    <label class="text-black" for="head-font">Шрифт заголовка</label>
                        ...
                        <div>
                            <div class="row form-group">
                                <div class="col text-center text-font">
                                    <label class="text-black" for="head-font">Шрифт текста</label>
                        ...
                        <div>
                            <div class="row form-group">
                                <div class="col text-center">
                                    <h4>Текст и заголовки</h4>
                                </div>
                                <div class="w-100"></div>
                                <div class="col">
                                    <div class="w-100"></div>
                                    <div class="col">
                                        <label for="customRange2" class="tc">Жирность</label> <select id="font-weight-text"><option>3</option><option selected="">2</option><option>1</option> </select></div>
                                    <div class="w-100"></div>
                                    <div class="col"> <label for="customRange2" class="tc">Размер</label> <select id="font-size-range"><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option selected="">16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option><option>25</option><option>26</option><option>27</option> </select></div>
                                </div>
                                <div class="col"> <label for="customRange2" class="tc">Жирность</label> <select id="font-weight-head"><option selected="">3</option><option>2</option><option>1</option> </select></div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="row w-100">
                            <div class="col-4">
                                <button type="button" class="btn btn-secondary d-inline-block" id="reset-color">Сбросить</button>
                            </div>
                            <div class="col-8">
        ...
        <div class="bottom__cookie-block">
            <p>Мы используем cookie только для сохранения ваших настроек сайта.<span class="ok lc">&nbsp;&nbsp; Oк</span>
            </p>
        ...
        <div class="site-wrap bc" id="home-section">
            ...
            <div class="container d-none d-lg-block">
                <div class="row">
                    <div class="col-12 text-center mb-4 mt-5">
                        <a href="#" class="text-black h2 mb-0">Usite<span
                                class="lc">.</span> </a>
                    </div>
                </div>
            </div>
            <header class="site-navbar py-md-4 js-sticky-header site-navbar-target" role="banner">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-10 main-menu">
                            <nav class="site-navigation position-relative text-right" role="navigation">
                                ...
                                <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                    <li><a href="#home-section" class="nav-link">Начало</a></li>
                                    <li><a href="#features-section" class="nav-link">Функции</a></li>
                                    <li><a href="#blog" class="nav-link">Блог</a></li>
                                    <li><a href="#contact-section" class="nav-link">Контакты</a></li>
                                    <li>
                                        <a class="nav-link" href="#customize" data-toggle="modal" data-target="#modalSettings" id="customize-btn">
                        ...
                        <div class="col-6 col-md-6 d-inline-block d-lg-none ml-md-0"><a href="#" class="site-menu-toggle js-menu-toggle text-black float-right"><i class="fas fa-bars"></i></a></div>
                        ...
                        <div class="col-md-12" style="position: relative;" data-aos="fade-up">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 mr-auto">
                                    <h1>Пусть люди создают дизайн вашего сайта.</h1>
                                    <p class="mb-5 c">Создавайте контент.</p>
                                    <div>
                                        <a href="#features-section" class="btn btn-primary mr-2 mb-2">Начать</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-12 text-center">
                            <h2 class="section-title mb-3 c-bc">Неограниченные возможности настройки<span class="lc">:</span></h2>
                        </div>
                    </div>
                    <div class="row align-items-stretch feature" role="navigation">
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            ...
                            <div class="unit-4 d-block">
                                ...
                                <div>
                                    ...
                                    <p>Разукрасьте впечатления.<span style="opacity:0">наслаждайтесь</span></p>
                                    <p><a href="#color-sheme-div">Узнать больше</a></p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            ...
                            <div class="unit-4 d-block">
                                <div class="unit-4-icon mb-3">
                                    <span class="icon-wrap"><span class="lc"><i
                                            class="fas fa-ruler-combined"></i></span></span>
                                </div>
                                <div>
                                    <h3>Размер блоков</h3>
                                    <p>Растягивайте, сжимайте, наслаждайтесь.</p>
                                    <p><a href="#layout">Узнать больше</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            <div class="unit-4 d-block">
                                ...
                                <div>
                                    <h3>Расположение</h3>
                                    <p>Нужная информация в нужном месте.&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                    <p><a href="#layout">Узнать больше</a></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            <div class="unit-4 d-block">
                                <div class="unit-4-icon mb-3">
                                    <span class="icon-wrap"><span class="lc"><i
                                            class="fas fa-border-none"></i></span></span>
                                </div>
                                <div>
                                    <h3>Шаблоны элементов</h3>
                                    <p>Выберайте вид.<span style="opacity:0">свойдизайнвыбралсамюзер.</span></p>
                                    <p><a href="#templates">Узнать больше</a></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            <div class="unit-4 d-block">
                                ...
                                <div>
                                    <h3>Размер текста и шрифт</h3>
                                    <p>Типография под вашим контроллем.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                    <p><a href="#typography-div">Узнать больше</a></p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                            <div class="unit-4 d-block">
                                ...
                                <div>
                                    <h3>Специально для вашего сайта</h3>
                                    <p>Ваши возможности настройки.<span style="opacity:0">адаптивныйс</span></p>
                                    <p><a href="#contact-section">Предложить</a></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="mt-5 row mb-5 site-section" style="border-top:1px solid var(--t-color)">
                    <div class="pr-lg-5 m-auto text-center mt-5 order-2 order-lg-1">
                        <h2 class="text-black">Это демо-сайт технологии Usite.</h2>
                        <p class="mb-4">Usite - сайт, где пользователь сам выбирает дизайн. Сделайте это!</p>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-lg-7 tutorial">
                            <img src="images/tut-ru.jpg" alt="Обучение как открыть меню" class="img-fluid">
                        </div>
                        <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
                            <h2 class="text-black" id="color-sheme-heading">Цветовая схема</h2>
                            <p class="mb-4 color-sheme-text">Пользователь выбирает все цвета в цветовой гамме. Создаст новые впечатления и "освежит" ваш сайт. Также пользователи могут менять цвета отдельного блока, наведя курсор на правый верхний угол и в выпадающем меню выбрать "Изменить
                                цвета".
                            </p>
                            <ul class="mb-5 list-unstyled">
                                <li class="color-sheme-text"><i class="fas fa-check"></i>  Может быть реализовано на любом сайте
                                </li>
                                <li class="color-sheme-text"><i class="fas fa-check"></i> Свобода настройки (например: градиент вместо цветов)</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="feature-big bc">
                ...
                <div class="container">
                    <div class="mt-5 row mb-5 site-section" id="layout">
                        ...
                        <div class="col-lg-7 order-1 order-lg-2">
                            <div class="author-box position-relative tf bc-c c-bc" id="div1">
                                <div>
                                    <a href="#" role="button" class="dropdown-link" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                                        class="fas fa-caret-down"></i></a>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item drag-on">Перетащить</a>
                                        <a class="dropdown-item resize-on">Изменить размер</a>
                                        <a class="dropdown-item dropdownColor" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Изменить цвет</a>
                                        <a class="dropdown-item return">Вернуть к ориг. положению</a>

                                        <div class="dropdown-menu" aria-labelledby="dropdownColor">
                                            <a class="dropdown-item">Текст<input type="color" value="#A8A8A8"
                                                class="dropColor"></a>
                                            <a class="dropdown-item">Фон<input type="color" value="#ffffff"
                                                class="dropBackColor"></a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex mb-4">
                                    <div class="mr-3">
                                        <img src="images/me.jpg" alt="Моя собака" class="img-fluid rounded-circle">
                                    </div>
                                    <a href="http://mmavliev.com" target="_blank" rel="noopener">
                                        <div class="mr-auto text-black">
                                            <strong class="font-weight-bold mb-0 c-bc">Mарат M.</strong> <br> <span class="c-bc">Разработчик</span>
                                        </div>
                                    </a>
                                </div>
                                <blockquote>&ldquo;Привет! Это большой и важный текст. Например: новость, которая слишком большая чтобы комфортно прочитать ее в этом маленьком окне, но и не достаточно объемная для отдельной страницы. Так почему бы не увеличить это
                                    окно чтобы было удобно прочитать? Выберите "Изменить размер" в правом верхнем углу это блока и наведитесь на самый край блока и растяните его. Потом можно поставить блок обратно или скрыть его. После скрытия его можно
                                    вернуть в окне настроек.&rdquo;</blockquote>
                            </div>
                        </div>
                        <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
                            <h2 class="text-black">Настраивайте блоки контента</h2>
                            <p class="mb-4">Перетаскивайте и бросайте или изменяйте размер блоков. Идеально для блогов, форумов, веб-приложений и других часто посещаемых сайтов. Поможет пользователям сфокусироваться на нужной информации, закрыв все ненужное.
                                <br><span id="phone-warning" class="lc">Перетаскивание и растяжение недоступно на сенсорных экранах</span></p>
                            <ul class=" mb-5 list-unstyled">
                                <li><i class="fas fa-check"></i> Расположение будет сохранено</li>
                                <li><i class="fas fa-check"></i> Гибкая система, неограниченное колличество блоков и опций
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5 site-section border-bottom" id="typography-div">
                        ...
                        <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
                            <h2 class="text-black">Типография</h2>
                            <p class="mb-4">Изменяйте шрифт текста и заголовков, размер текста, жирность. Информация, написанная любимым шрифтом воспринимается лучше. Простая и мощная настройка.</p>
                            <ul class="mb-5 list-unstyled">
                                <li><i class="fas fa-check"></i> Большой выбор шрифтов.</li>
                                <li><i class="fas fa-check"></i> Широкий спектр сочетаний.</li>
                            </ul>
                    ...
                    <div class="mt-5 row mb-5 site-section" id="templates">
                        <div class="col-lg-4 ml-auto order-1 order-lg-2">
                            <button type="button" class="btn btn-primary d-inline-block" id="button-hover">Наведись на
                            меня!</button>
                        </div>
                        <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
                            <h2 class="text-black">Шаблоны элементов</h2>
                            <p class="mb-4">Выбирайте структуры элементов. На данном сайте - вид кнопок при наведении на них. Какие настройки бы вы хотели на вашем сайте? Анимации при наведении? Шаблоны постов в блоге? Всё что вы пожелаете - можно воплотить.</p>
                            <ul class=" mb-5 list-unstyled">
                                <li><i class="fas fa-check"></i> Полностью индивидуально для вас и вашего сайта.</li>
                                <li><i class="fas fa-check"></i> Неограниченная свобода настроек.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row mb-5 site-section border-bottom">
                        <div class="col-lg-7">
                            <button id="reload-btn" class="btn btn-primary mr-2 mb-2">Перезагрузить и убедиться</button>
                        </div>
                        <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
                            <h2 class="text-black">Все будет сохранено</h2>
                            <p class="mb-4">Все ваши изменения сохранены в cookie файлы, так что они останутся даже если вы выключите компьютер</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="site-section bc-t" id="custom">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-12 text-center">
                            <h2 class="section-title mb-3">Идея<span class="lc">:</span></h2>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-lg-5 ml-auto pl-lg-5">
                            <h2 class="mb-4 c-bc">Приблизьте ваш сайт к пользователям</h2>
                            <p class="mb-4 c-bc">Невозможно создать сайт дизайн которого понравится всем. Особенно если сайт посещает тысячи пользователей. Поэтому, у большинства таких сайтов простой и похожий дизайн. Без рисков, ведь никто не хочет посещать сайт дизайн которого
                                им сильно не нравится. Так, вместо того чтобы дизайн сайта нравился <u>большинству</u> людей, почему бы не дать возможность <u>людям
                            </u> создавать дизайн для себя. Пользователям достаточно минуты чтобы настроить сайт.</p>
                        </div>
                        <div class="col-lg-6">
                            <img src="images/about_1.jpg" alt="Люди думают" class="img-fluid mb-5 mb-lg-0 rounded shadow">
                        </div>
                    </div>
            ...
            <div class="site-section" id="blog-section">
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-12 text-center">
                            <h2 class="text-black mb-3">Блог</h2>
                        </div>
                    </div>
                    <div class="row text-center" id="blog">
                        <div class="col-md">
                            <div class="h-entry">
                                ...
                                <h2><a href="#">Сколько времени займёт интеграция "Usite"?</a></h2>
                                <div class="tc mb-4">Марат Мавлиев <span class="mx-2 tc">&bullet;</span> Сегодня<span class="mx-2">&bullet;</span> <span class="lc">FAQ</span></div>
                                <p>2-3 дня. 1 день - меню в стиль вашего сайта, подготовка html&css. 2 день - вся JS логика. 3 день - оптимизация.</p>
                            </div>
                        </div>
...
<g>
	...
	<path d="M461.542,263.611c5.295-17.056,4.034-35.316-3.551-51.416c-1.766-3.748-6.234-5.354-9.981-3.589   c-3.748,1.766-5.354,6.234-3.588,9.981c5.983,12.7,6.976,27.109,2.795,40.575c-4.204,13.54-13.286,24.903-25.573,31.997   c-13.002,7.508-28.151,9.5-42.652,5.615c-14.502-3.886-26.624-13.187-34.13-26.189c-15.497-26.841-6.267-61.285,20.574-76.782   c19.625-11.329,43.98-9.815,62.051,3.857c3.304,2.5,8.007,1.849,10.506-1.455c2.499-3.303,1.848-8.007-1.456-10.506   c-22.891-17.321-53.745-19.238-78.602-4.887c-16.472,9.51-28.255,24.866-33.178,43.238s-2.396,37.562,7.114,54.034   c9.51,16.473,24.866,28.255,43.238,33.179c6.135,1.644,12.361,2.457,18.546,2.457c12.338,0,24.517-3.236,35.488-9.571   C444.71,295.163,456.216,280.767,461.542,263.611z"/>
                                ...
                                <h2><a href="#">Влияет ли "Usite" на SEO?</a></h2>
                                <div class="tc mb-4">Марат Мавлиев <span class="mx-2 tc">&bullet;</span> Сегодня<span class="mx-2">&bullet;</span> <span class="lc">FAQ</span></div>
                                <p>Нет. К вашему сайту добавляется JS файл и окно с настройками, немного меняется CSS файл. Все остальное остается прежним.</p>
                            </div>
                        </div>
        ...
        <div class="site-section bc-t" id="contact-section">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12 text-center">
                        <h2 class="section-title mb-3">Хотите Usite на вашем сайте? Свяжитесь с нами!</h2>
                    </div>
                </div>
                    ...
                    <div class="col-lg-7 mb-5">
                        ...
                        <form action="#" class="p-5 bc">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="text-black" for="topic">Тема</label>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-12">
                                    <label class="text-black" for="email">Эл. почта</label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="7" class="form-control rounded-0" placeholder="Напишите сюда свои вопросы и предложения..."></textarea>
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="button" value="Отправить" class="btn btn-primary mr-2 mb-2" id="submit-btn">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="footer py-5 border-top text-center bc">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-12">
                        <p class="mb-0">
                            <a href="https://www.instagram.com/usite.tech/" class="p-3" aria-label="Мой IG"><i class="fas fa-instagram"></i></a>
                            <a href="mailto:maratmavliev@mail.ru" class="p-3" aria-label="Написать мне"><i class="fas fa-envelope"></i></a>
                            <a target="_blank" rel="noopener" href="http://mmavliev.com" class="p-3" aria-label="Мой сайт!"><i class="fas fa-link"></i></a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- <div class="container">
            <div class="col form-group text-center w-100" id="deleted-content"></div>
        </div> -->
        <!-- .site-wrap -->
        ...
        <script>
            $("#submit-btn").click(function() {
                $.ajax({
                    ...
                    type: "POST",
                    data: "fname=" + $("#fname").val() + "&topic=" + $("#topic").val() + "&email=" + $(
                        "#email").val() + "&message=" + $("#message").val(),
                    success: function() {
                        $("form").empty();
                        $("form").html("<p class='text-black'>Ваше сообщение успешно отправлено.</p>")
